...
import com.conceptualgraph.cgif.generate.NameGenerator;
...
public class CGIFParser implements CGIFParserConstants {
    ...
    public Graph parseCGIFString(String contents) throws ParseException {
        // Use UTF_8 to handle Unicode characters like Em-Dashes in comments
  ...
  final public Graph graph(Graph enclosingGraph) throws ParseException {Graph g;
...
{if ("" != null) return g;}
  ...
  final public void concept(Graph g) throws ParseException {Token tBracket;
    Token tType = null;
...
if (Global.importSubtypeRelationsAsHierarchy ) {
      ...
      graph = graph(g);
      tBracket = jj_consume_token(RBRACKET);
if ( tType != null ) graph.setTextLabel( tType.image.replace("\"", ""));
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case LBRACKET:{
        jj_consume_token(LBRACKET);
        ...
        tBracket = jj_consume_token(RBRACKET);
String label = (tType.image == null) ? "" : tType.image.replace("\"", "");
        concept = helper.makeConcept( g, label, referent, helper.extractChargerComment( tType, tBracket ) );
        break;
        }
      default:
        jj_la1[7] = jj_gen;
...
ref = new Referent(t.image.replace("\"", ""));
        ref.setReferentString(t.image.replace("\"", ""), false);
        {if ("" != null) return ref;}
        break;
        }
      case INTEGER_LITERAL:
...
if ( r.getVariable() != null )
        ...
        rparen = jj_consume_token(RPAREN);
try {
            helper.makeRelation( g, rname.image, variables, helper.extractChargerComment( rname, rparen ) );
  ...
  final public void actor(Graph g) throws ParseException {Token aname;
    Token rparen;
    Referent r = null;
...
try {
  ...
  final public String variable() throws ParseException {String prefix = null; Token var = null;
    prefix = prefix();
...
{if ("" != null) return (prefix == null ? "" : prefix) + var.image;}
  ...
  final public String prefix() throws ParseException {Token pre = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case QUESTIONMARK:{
...
{if ("" != null) return pre.image;}
  ...
  final public Referent setReferent() throws ParseException {Referent ref = new Referent(); Referent r; String card = null;
    jj_consume_token(LBRACE);
    r = referent();
ref.addSetMember( r );
    label_5:
...
if ( card != null ) ref.setCardinality( card ); {if ("" != null) return ref;}
  ...
  final public String cardinality() throws ParseException {Token d = null;
