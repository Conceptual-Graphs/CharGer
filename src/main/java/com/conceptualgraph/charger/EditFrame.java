...
import com.conceptualgraph.charger.obj.Note;
...
import com.conceptualgraph.chargerlib.history.UserHistoryRecord;
...
//	 OPERATIONAL INFORMATION ABOUT THIS FRAME
    ...
    /**
     * an absolute or relative path including trailing sep (e.g., "CG/com.conceptualgraph.Graphs/" )
     */
    ...
    public void mousePressed( MouseEvent me ) {
        ...
        if ( ( currentObject != null ) ) {
            ...
            if ( Global.wordnetEnabled && currentObject instanceof GNode
                ...
                //com.conceptualgraph.charger.Global.info( ((GNode)currentObject).getTypeDescriptor().toXML( "  " ) );
...
//        }
    ...
    private void refreshDescriptorPanel( AbstractTypeDescriptor[] something ) {
        ...
        JTable descriptorTable = com.conceptualgraph.charger.gloss.wn.WNUtil.getDescriptorTable( something );
