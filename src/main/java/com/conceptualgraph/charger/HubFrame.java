...
import com.conceptualgraph.chargerplugin.ModuleException;
...
//        EmailAddressLabel.setSize( new java.awt.Dimension( 255, 20 ) );
        ...
        WebAddressButton.setText( "https://github.com/Conceptual-Graphs/CharGer" );
        ...
        WebAddressButton.addActionListener( new java.awt.event.ActionListener() {
            public void actionPerformed( java.awt.event.ActionEvent e ) {
                try {
                    Desktop.getDesktop().browse( new java.net.URI( "https://github.com/Conceptual-Graphs/CharGer" ) );
                } catch ( Exception ee ) {
                    CGUtil.showMessageDialog( hub,
                            "Browser not enabled in this context. Go to \"https://github.com/Conceptual-Graphs/CharGer\"." );
                }
            }
        } );
...
//        icon.setFont( new java.awt.Font( "Arial", Font.BOLD, 12 ) );
        ...
        AvailLabel.setText( "com.conceptualgraph.Graphs available" );
...
//            Global.craftModule = new com.conceptualgraph.craft.Craft();
//        }
...
//        for ( String filename : GraphDisplayList.getModel() ) {
     ...
     * @see com.conceptualgraph.charger.ModulePlugin
     */
