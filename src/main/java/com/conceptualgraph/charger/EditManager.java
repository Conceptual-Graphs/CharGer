...
import com.conceptualgraph.charger.cgx.CGXGenerator;
...
import com.conceptualgraph.charger.obj.Actor;
...
import com.conceptualgraph.charger.obj.RelationLabel;
import com.conceptualgraph.charger.obj.ShallowIterator;
...
import com.conceptualgraph.chargerlib.FontChooser;
import com.conceptualgraph.chargerlib.General;
import com.conceptualgraph.chargerlib.GenericTextFrame;
import com.conceptualgraph.chargerlib.Tag;
import com.conceptualgraph.chargerlib.undo.UndoStateManager;
import com.conceptualgraph.chargerlib.undo.Undoable;
import com.conceptualgraph.chargerlib.undo.UndoableState;
...
//    com.conceptualgraph.charger.xml.CGXParser parser = new com.conceptualgraph.charger.xml.CGXParser();
    // Stuff for undo/redo
...
//        }
    ...
    public void performActionClipboardCopy() {
        ...
        com.conceptualgraph.charger.obj.Graph g = new com.conceptualgraph.charger.obj.Graph( null );
...
//        ef.resetSelection();
    ...
    public void performActionDisplayAsCGIF() {
        ...
        File suggestedFile = new File( suggestedPath + ".com.conceptualgraph.cgif" );
        ...
        ef.CGIFDisplay.setTheText( com.conceptualgraph.cgif.generate.CGIFWriter.graphToString( ef.TheGraph, Global.includeCharGerInfoInCGIF ) );
    ...
    public void performActionDisplayAsXML() {
        ...
        ef.XMLDisplay.setTheText(com.conceptualgraph.charger.cgx.CGXGenerator.generateXML( ef.TheGraph ) );
...
//        String today = DateFormat.getDateTimeInstance( DateFormat.MEDIUM, DateFormat.MEDIUM ).format( now );
        ...
        //ef.metricsDisplay.setText( com.conceptualgraph.charger.xml.CGXGenerator.generateXML( ef.TheGraph ) );
...
//                IOManager.saveGraph38XML( out, g );
     ...
     *
     * @see com.conceptualgraph.chargerlib.undo.Undoable
     */
    public EditorState currentState() {
        EditorState state = new EditorState( com.conceptualgraph.charger.cgx.CGXGenerator.generateXML( ef.TheGraph ) );
...
//        newOnes = parser.parseCGXMLString( backupGraph, ef.TheGraph, new Point2D.Double( 0, 0 ), true );
     ...
     *
     * @see com.conceptualgraph.charger.layout.SpringGraphLayout
     */
...
//    }
    ...
    public void makeHoldGraph() {
        ...
        OperManager.performActionValidate( ef.TheGraph );
        ef.sp.repaint();
        holdGraph = com.conceptualgraph.charger.cgx.CGXGenerator.generateXML( ef.TheGraph );
