...
import com.conceptualgraph.charger.exception.CGActorException;
 ...
 * interface must be in the package named "com.conceptualgraph.actorplugin". Responsibility for
 * extracting referents from the com.conceptualgraph.charger.obj.Concept arguments lies with the
 * class implementing the interface; some convenience methods are found in
 * com.conceptualgraph.charger.act.GraphUpdater.
 *
 * @see com.conceptualgraph.charger.act.GraphUpdater
...
public interface ActorPlugin {
     ...
     * actor constraints.
     * @see com.conceptualgraph.charger.act.GraphUpdater#GraphObjectAttributes
     */
     ...
     * further updating
     * @param inputs ArrayList of com.conceptualgraph.charger.obj.Concept
     * @param outputs ArrayList of com.conceptualgraph.charger.obj.Concept, set by the operation and
