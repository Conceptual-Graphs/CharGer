...
//
package com.conceptualgraph.charger.gloss;
 ...
 *
 * @see com.conceptualgraph.craft.SenseQueryDialog
 * @see com.conceptualgraph.charger.xml.CGXParser
 * @see com.conceptualgraph.charger.wn.WordnetTypeDescriptor
 */
abstract public class AbstractTypeDescriptor {
    ...
    public boolean equals( AbstractTypeDescriptor d ) {
    	com.conceptualgraph.charger.Global.info( "comparing descriptors: LHS: " + label + " " + partofspeech + " RHS: "
                + d.getLabel() + " " + d.getPOS() );
