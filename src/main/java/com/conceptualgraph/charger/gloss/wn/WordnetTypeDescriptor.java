 ...
 */
public class WordnetTypeDescriptor extends com.conceptualgraph.charger.gloss.AbstractTypeDescriptor {
    ...
    public WordnetTypeDescriptor( String posString, long offset ) {
        //com.conceptualgraph.charger.Global.info( "entering wordnet descriptor with pos " + posString + " and offset " + offset );
        ...
        //com.conceptualgraph.charger.Global.info( "leaving wordnet descriptor with validated = " + validated );
    }
     ...
     * @see com.conceptualgraph.charger.xml.CGXParser
     */
    public static com.conceptualgraph.charger.gloss.AbstractTypeDescriptor getInstanceFromXML(org.xml.sax.Attributes attrs ) {
        //com.conceptualgraph.charger.Global.info( "wordnet's getinstance, attrs are " + attrs );
        ...
        return (com.conceptualgraph.charger.gloss.AbstractTypeDescriptor)d;
    }
        ...
        //Craft.say( " getting instance from XML; descr is " + descr.toString() );
