...
//
package com.conceptualgraph.charger.gloss.wn;

import com.conceptualgraph.charger.gloss.AbstractTypeDescriptor;
import com.conceptualgraph.charger.gloss.GenericTypeDescriptor;
...
public class WordnetManager {
    ...
    public static String wordnetDictionaryFilename =
    		com.conceptualgraph.charger.Global.Prefs.getProperty("wordnetDictionaryFilename", "/dev/null");		// make sure it's working
...
//            }
        	...
        	com.conceptualgraph.charger.Global.info("before making file input stream from " + WordnetManager.wordnetDictionaryFilename);
...
////            if (fis == null) {
////                com.conceptualgraph.charger.Global.warning("File not found : " + fullname);
////                com.conceptualgraph.charger.Global.warning("Continuing without Wordnet available");
////            }
...
//            }
            ...
            // on the PC
            com.conceptualgraph.charger.Global.info("before initialize() call");
            ...
            com.conceptualgraph.charger.Global.info("after initialize() call");
            dict = net.didion.jwnl.dictionary.Dictionary.getInstance();
            com.conceptualgraph.charger.Global.consoleMsg("Wordnet initialized. Publisher: " + JWNL.getVersion().getPublisher()
        	...
        	com.conceptualgraph.charger.Global.error("JWNL Exception at initialization: " + je.getMessage());
            je.printStackTrace();
            initializationFailed = true;
        }
        //com.conceptualgraph.charger.Global.info( "end of initializewordnet with initialization failed = " +
    ...
    /*private static void initializeWordnet( String dictionaryFile )
     ...
     "</jwnl_properties>";
     try {
     com.conceptualgraph.charger.Global.info( "before making file input stream" );
     ...
     { 
     //JOptionPane.showMessageDialog( null, "JWNL Exception: " + je.getMessage() ); 
     com.conceptualgraph.charger.Hub.error( "JWNL Exception at initialization: " + je.getMessage() );
     initializationFailed = true;
     }
     //com.conceptualgraph.charger.Global.info( "end of initializewordnet with initialization failed = " +
     //		initializationFailed );
        ...
        try {
            ...
            if (iwords.length > 0) {
                for (int iwnum = 0; iwnum < iwords.length; iwnum++) {
                    ...
                    Craft.say("processing indexword " + iwnum + " with lemma " + iw.getLemma() + "; "
     ...
     * the word. If Wordnet knows nothing about the word, but the word contains
    ...
    public AbstractTypeDescriptor queryForSense(
        ...
        if (com.conceptualgraph.charger.gloss.Preposition.isPreposition(word)) {
        	...
        	com.conceptualgraph.craft.SenseQueryDialog dialog = new com.conceptualgraph.craft.SenseQueryDialog(
                    new Frame(), word, phrase, initialOption, tryGeneric);
            ...
            if (descr instanceof WordnetTypeDescriptor) {
                ...
                try {
                    ...
                    for (int p = 0; p < pointers.length; p++) {
                        Craft.say("hypernym " + p + " is " + pointers[ p].getTarget().toString());
                    }
        	...
        	com.conceptualgraph.craft.SenseQueryDialog dialog = new com.conceptualgraph.craft.SenseQueryDialog(
                    null, word, phrase, initialOption, true);
    ...
    public boolean attachDescriptor(AbstractTypeDescriptor descr, GNode gn) {
    	com.conceptualgraph.charger.Global.info("attach descriptor " + descr);
    ...
    public GenericTypeDescriptor chooseGenericSense(
    	...
    	com.conceptualgraph.craft.SenseQueryDialog dialog = new com.conceptualgraph.craft.SenseQueryDialog(null, word, phrase, initialOption, true);
