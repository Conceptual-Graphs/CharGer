...
import static com.conceptualgraph.charger.Global.getLogFile;
...
//                }
                ...
                setInfoOn = true;
//            } else if ( args[argnum].equalsIgnoreCase( "-com.conceptualgraph.craft" ) ) {
//                Global.craftEnabled = true;
        ...
        com.conceptualgraph.charger.Global.setupAll(/* me,*/ graphFolder, extraArgs, setInfoOn );	// tell Charger who its controlling process is.
...
//        }
        ...
        //com.conceptualgraph.charger.Global.info( prop + " = " + System.getProperty( prop ) );
...
/*
	...
	Knowledge Bases:
		...
		but having no graphs of its own. com.conceptualgraph.Graphs will be stored somewhere else, usually an edit frame.
	Type Definitions:
