...
//            backgroundTile.repaint();
    ...
    public void changeFont( ) {
        this.font = font;
        Iterator<GraphObject> iter = emgr.ef.EFSelectedObjects.iterator();
        while ( iter.hasNext() ) {
    ...
    private void initComponents() {
        ...
        boldButton = new javax.swing.JLabel();
        italicButton = new javax.swing.JLabel();
        ...
        alignVerticallyButton.setBackground(new java.awt.Color(255, 255, 255));
        alignVerticallyButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/AlignVIcon.gif"))); // NOI18N
        alignVerticallyButton.setToolTipText("Align selected items vertically");
        alignVerticallyButton.setAlignmentX(0.5F);
        alignVerticallyButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        alignVerticallyButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        alignVerticallyButton.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/AlignVIconInverted.gif"))); // NOI18N
        ...
        alignHorizontallyButton.setBackground(new java.awt.Color(255, 255, 255));
        alignHorizontallyButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/AlignHIcon.gif"))); // NOI18N
        alignHorizontallyButton.setToolTipText("Align selected items horizontally");
        alignHorizontallyButton.setAlignmentX(0.5F);
        alignHorizontallyButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        alignHorizontallyButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        alignHorizontallyButton.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/AlignHIconInverted.gif"))); // NOI18N
        ...
        fontNameMenu.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        ...
        fontSizeMenu.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        ...
        backgroundTile.setBackground(new java.awt.Color(255, 255, 255));
        backgroundTile.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        ...
        foregroundTile.setBackground(new java.awt.Color(255, 255, 255));
        foregroundTile.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        ...
        boldButton.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        boldButton.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        boldButton.setText("B");
        boldButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        italicButton.setFont(new java.awt.Font("Times New Roman", 3, 24)); // NOI18N
        italicButton.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        italicButton.setText("I");
        italicButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    private javax.swing.JLabel boldButton;
    ...
    private javax.swing.JLabel italicButton;
