...
import com.conceptualgraph.charger.obj.EdgeAttributes;
import com.conceptualgraph.charger.obj.Graph;
import com.conceptualgraph.charger.obj.GraphObjectID;
import com.conceptualgraph.charger.prefs.PreferencesFrame;
...
import com.conceptualgraph.chargerplugin.ModulePlugin;
 ...
 * call.
 * <pre>
 * com.conceptualgraph.charger.Global.setup();
 * </pre> <li>In the places where the driver needs to exit, the call
 * <pre>
 * com.conceptualgraph.charger.Global.closeOutAll();
...
//  KNOWLEDGE BASE STUFF
    public static com.conceptualgraph.kb.KnowledgeBase sessionKB = new com.conceptualgraph.kb.KnowledgeBase( "sessionKB" );
////========================================================================================
////	 ANYTHING CHARGER NEEDS TO KEEP TRACK OF CRAFT (requirements tool)
//    public static boolean craftEnabled = false;
//    public static com.conceptualgraph.craft.Craft craftModule = null;
//========================================================================================
...
//	 ANYTHING CHARGER NEEDS FOR MATCHING AND METRICS
     ...
     * matching.
     *
     * @see com.conceptualgraph.kb.KnowledgeManager#createCurrentTupleMatcher
     */
    public static boolean mmatEnabled = false;
    public static com.conceptualgraph.kb.KnowledgeManager knowledgeManager = new com.conceptualgraph.kb.KnowledgeManager();
...
//	 ACTOR SETUP, FIRING AND ANIMATION
    ...
    /**
     * A list of file names and com.conceptualgraph.charger.db.Database objects, representing all
     * known Databases
     */
...
//    public static Hashtable<String, EdgeAttributes> userEdgeAttributes = new Hashtable<String, EdgeAttributes>(3);
     ...
     * com.conceptualgraph.charger.obj class names, default foreground (text) color
     */
     ...
     * com.conceptualgraph.charger.obj class names, default background (fill) color
     */
...
//        defaultLogicalFontName = Prefs.getProperty("defaultLogicalFontName", "SansSerif");
    ...
    /**
     * Starts up the main com.conceptualgraph.charger application.
     *
     * @param driver
...
//        Craft.CRAFTGridFolder = com.conceptualgraph.charger.Global.Prefs.getProperty( "GridFolder", "com.conceptualgraph.Graphs" );
//        Craft.CRAFTGridFolderFile = new File( Craft.CRAFTGridFolder);
//
//        Craft.CRAFTtryGenericSenseInRepGrid =
//                com.conceptualgraph.charger.Global.Prefs.getProperty( "CRAFTtryGenericSenseInRepGrid", "false" ).equals( "true" );
//        Craft.CRAFTuseOnlyBinaryRelationsinCraft =
//                com.conceptualgraph.charger.Global.Prefs.getProperty( "CRAFTuseOnlyBinaryRelationsinCraft", "false" ).equals( "true" );
//        Craft.CRAFTuseOnlyGenericConceptsinCraft =
//                com.conceptualgraph.charger.Global.Prefs.getProperty( "CRAFTuseOnlyGenericConceptsinCraft", "false" ).equals( "true" );
//
        wordnetEnabled = Global.Prefs.getProperty( "wordnetEnabled", "false" ).equals( "true" );
        matchingStrategy = Global.Prefs.getProperty( "matchingStrategy", "com.conceptualgraph.kb.matching.BasicTupleMatcher" );
...
//              JOptionPane.showMessageDialog( null, "Master frame created.");
    	 ...
    	 com.conceptualgraph.charger.Global.error( "Hub.setup internal error: can't create master frame: " + e.getMessage() );
           e.printStackTrace();
        }
...
//        consoleMsg( "MMAT Subsystem enabled: " + mmatEnabled );
    ...
    public static boolean closeOutAll() {
        ...
        while ( dbs.hasNext() ) {
        	com.conceptualgraph.charger.db.CGDatabase db = (com.conceptualgraph.charger.db.CGDatabase)dbs.next();
            if ( db != null ) {
                ( (com.conceptualgraph.charger.db.TextDatabase)db ).closeDB();
            }
        }
...
//    }
     ...
     * @see com.conceptualgraph.charger.db.CGDatabase
     */
    public /*synchronized*/ static com.conceptualgraph.charger.db.CGDatabase activateDatabase(String filename )
            throws CGFileException {
        // info("hub activating " + filename );
        String simplename = General.getSimpleFilename( filename );
        com.conceptualgraph.charger.db.CGDatabase db = (com.conceptualgraph.charger.db.CGDatabase)ActiveDatabases.get( simplename );
        if ( db == null ) {
            try {
                db = new com.conceptualgraph.charger.db.TextDatabase( filename );
...
//    public static PreferencesWindow pw;
    ...
    /**
     * Checks for strings ending in com.conceptualgraph.charger cgx extension, but not starting with ".". Used in
    ...
    /**
     * Checks for strings ending in ".com.conceptualgraph.cgif" or "CGIF", but not starting with
