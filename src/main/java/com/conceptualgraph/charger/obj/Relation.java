...
public class Relation extends GNode {
    ...
    public Relation() {
        ...
        displayRect3D.height =  displayRect3D.height * 0.75;  
    }
...
//        super.setTextLabel(General.makeLegalChars( label, CharacterSets.TYPE_LABEL_CHARSET ) );
    ...
    /* REMOVE-NOTIO public void updateForNotio(  notio.KnowledgeBase com.conceptualgraph.kb )
     ...
     notio.RelationType rt = com.conceptualgraph.kb.getRelationTypeHierarchy().getTypeByLabel( notioTypeLabel );
     if ( rt == null )
     {
     rt = new notio.RelationType( textLabel );
     com.conceptualgraph.kb.getRelationTypeHierarchy().addTypeToHierarchy( rt );
     }
