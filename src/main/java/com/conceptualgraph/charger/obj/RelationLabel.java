...
//            Global.info( "Relation \"" + this.getTypeLabel() + "\" added = " + b + " " + com.conceptualgraph.kb.showRelationTypeHierarchy() );
        if ( node == null ) {
            return false;
        } else {
...
//            Global.info( "Relation \"" + this.getTypeLabel() + "\" removed = " + b + " " + com.conceptualgraph.kb.showRelationTypeHierarchy() );
        return b;
    }
     ...
     *
     * @param com.conceptualgraph.kb Notio knowledge base, to be used for storing the relation type.
     */
   /* REMOVE-NOTIO  public void updateForNotio( notio.KnowledgeBase com.conceptualgraph.kb ) {
        try {
            ...
            if ( textLabel.equalsIgnoreCase( "link" ) ) {
                r = com.conceptualgraph.kb.getRelationTypeHierarchy().getTypeByLabel( notio.RelationTypeHierarchy.UNIVERSAL_TYPE_LABEL );
            } else {
                r = com.conceptualgraph.kb.getRelationTypeHierarchy().getTypeByLabel( textLabel );
            }
