...
public class ActorsPrefPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        DatabaseFolderField.setText(Global.DatabaseFolderString);
    ...
    allowActorLinksAcrossContexts.setBackground(new java.awt.Color(255, 255, 255));
    ...
    allowNullActorArguments.setBackground(new java.awt.Color(255, 255, 255));
    ...
    enableActors.setBackground(new java.awt.Color(255, 255, 255));
    ...
    enableCopyCorefs.setBackground(new java.awt.Color(255, 255, 255));
    ...
    actorAnimation.setBackground(new java.awt.Color(255, 255, 255));
    ...
    animationDelay.setBackground(new java.awt.Color(255, 255, 255));
    ...
    use_1_0_actors.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void DatabaseFolderFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DatabaseFolderFieldActionPerformed
                Global.DatabaseFolderString = DatabaseFolderField.getText();
                Global.DatabaseFolderFile = new File( Global.DatabaseFolderString );
    }//GEN-LAST:event_DatabaseFolderFieldActionPerformed

    private void allowActorLinksAcrossContextsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_allowActorLinksAcrossContextsItemStateChanged
    ...
    private void allowNullActorArgumentsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_allowNullActorArgumentsItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
    ...
    private void enableActorsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_enableActorsItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
            Global.enableActors = true;
            // need to iterate through all windows and start all their actors - use startupAllActors()
            com.conceptualgraph.charger.act.GraphUpdater.startupAllActors();
        } else {
            ...
            com.conceptualgraph.charger.act.GraphUpdater.shutdownAllActors();
        }
    ...
    private void enableCopyCorefsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_enableCopyCorefsItemStateChanged
                if ( evt.getStateChange() == ItemEvent.SELECTED ) {
    ...
    private void use_1_0_actorsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_use_1_0_actorsItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
    ...
    private void actorAnimationItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_actorAnimationItemStateChanged
