...
import com.conceptualgraph.kb.KnowledgeManager;
...
public class CompatibilityPrefPanel extends javax.swing.JPanel  {
    ...
    private void initComponents() {
        ...
        saveHistoryRecords = new javax.swing.JCheckBox();
        ...
        GraphFolderField.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        ...
        GraphFolderField.setBorder(BorderFactory.createTitledBorder( Global.BeveledBorder,
            "com.conceptualgraph.Graphs Folder", TitledBorder.LEFT,
...
wordnetDictField.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
wordnetDictField.setText(com.conceptualgraph.charger.gloss.wn.WordnetManager.wordnetDictionaryFilename);
...
wordnetDictField.setBorder(BorderFactory.createTitledBorder( Global.BeveledBorder,
    ...
    wordnetLicense.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
    ...
    enforceStandardRelations.setBackground(new java.awt.Color(255, 255, 255));
    ...
    matchingStrategyList.setBackground(new java.awt.Color(255, 255, 255));
...
includeCharGerInfoInCGIF.addItemListener(new java.awt.event.ItemListener() {
    ...
    saveHistoryRecords.setSelected(true);
    saveHistoryRecords.setText("Save history records");
    saveHistoryRecords.setToolTipText("Save the recorded list of changes to this graph (does not affect reading them)");
    saveHistoryRecords.addItemListener(new java.awt.event.ItemListener() {
        public void itemStateChanged(java.awt.event.ItemEvent evt) {
            saveHistoryRecordsItemStateChanged(evt);
        }
    });
                    ...
                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(layout.createSequentialGroup()
                            ...
                            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                ...
                                .add(saveHistoryRecords, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 276, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                        .add(layout.createSequentialGroup()
    ...
    private void GraphFolderFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraphFolderFieldActionPerformed
        Global.GraphFolderString = GraphFolderField.getText();
//            Global.GraphFolderFile = new File( Global.GraphFolderString );
    ...
    private void setDictFolderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setDictFolderActionPerformed
    	com.conceptualgraph.charger.gloss.wn.WNUtil.queryForDictFolder( null );
        wordnetDictField.setText( com.conceptualgraph.charger.gloss.wn.WordnetManager.wordnetDictionaryFilename );
    ...
    private void wordnetEnabledItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_wordnetEnabledItemStateChanged
    ...
    private void enforceStandardRelationsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_enforceStandardRelationsItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
    ...
    private void matchingStrategyListItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_matchingStrategyListItemStateChanged
    	com.conceptualgraph.charger.Global.matchingStrategy = (String)( matchingStrategyList.getSelectedItem() );
...
//                + "<TABLE width=\"" + matchingStrategyDisplayWidth + "\"><TR><TD>\n"
    ...
    private void includeCharGerInfoInCGIFItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_includeCharGerInfoInCGIFItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
    ...
    private void wordnetDictFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_wordnetDictFieldActionPerformed
    	com.conceptualgraph.charger.gloss.wn.WordnetManager.wordnetDictionaryFilename = wordnetDictField.getText();
    }//GEN-LAST:event_wordnetDictFieldActionPerformed

    private void exportSubtypesAsRelationsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_exportSubtypesAsRelationsItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
    ...
    private void importSubtypeRelationsAsHierarchyItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_importSubtypeRelationsAsHierarchyItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
    ...
    private void saveHistoryRecordsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_saveHistoryRecordsItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
            Global.saveHistoryRecords = true;
        } else {
            Global.saveHistoryRecords = false;
        }
    }//GEN-LAST:event_saveHistoryRecordsItemStateChanged
    ...
    public javax.swing.JCheckBox saveHistoryRecords;
