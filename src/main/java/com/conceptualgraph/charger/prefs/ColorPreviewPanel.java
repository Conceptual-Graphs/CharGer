...
import com.conceptualgraph.charger.obj.Coref;
 ...
 * @author hsd
 */
public class ColorPreviewPanel extends javax.swing.JPanel {
...
//    }
    ...
    private void initSampleGraphObject( String classname ) {
        ...
        // NOTE: this method depends on the graph objects being in the com.conceptualgraph.charger.obj package
        try {
            dummy1 = null;
            dummy2 = null;
            Class c = null;
            if ( classname.equals( "Cut")) 
                c = Class.forName( "com.conceptualgraph.charger.obj." + "Graph");
            else
            c = Class.forName( "com.conceptualgraph.charger.obj." + classname );
//                     this.getGraphics().setFont( Global.defaultFont );
            ...
            if ( classname.equals( "Graph" ) || classname.equals( "Cut")) {
                samplego = new com.conceptualgraph.charger.obj.Graph( new com.conceptualgraph.charger.obj.Graph( null ) );
                samplego.setDisplayRect( 15, 15, d.width - 30, d.height - 30 );
...
//                    samplego.setTextLabel( "Cut");
    ...
    restoreFactoryColors.setFont(new java.awt.Font("Lucida Grande", 0, 12)); // NOI18N
    ...
    chooseBlackAndWhite.setBackground(new java.awt.Color(255, 255, 255));
    chooseBlackAndWhite.setFont(new java.awt.Font("Lucida Grande", 0, 12)); // NOI18N
    ...
    chooseGrayscale.setBackground(new java.awt.Color(153, 153, 153));
    chooseGrayscale.setFont(new java.awt.Font("Lucida Grande", 0, 12)); // NOI18N
    ...
    sampleObjectPanel.setBackground(new java.awt.Color(204, 204, 204));
...
sampleObjectPanelLayout.setHorizontalGroup(
    ...
    graphObjectList.setBackground(new java.awt.Color(255, 255, 255));
    graphObjectList.setFont(new java.awt.Font("Lucida Grande", 0, 12)); // NOI18N
    ...
    foreColorPanel.setPreferredSize(new java.awt.Dimension(35, 35));
    ...
    backColorPanel.setPreferredSize(new java.awt.Dimension(35, 35));
    ...
    public javax.swing.JPanel sampleObjectPanel;
