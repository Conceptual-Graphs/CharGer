...
//            Global.Prefs.store( new FileOutputStream( prefsFilename ), Global.getInfoString() );
     ...
     * control for the preference <li>com.conceptualgraph.charger.Global (or other appropriate
    ...
    protected String prefsToString() {
        return "# " + new CDateTime().formatted( Global.ChargerDefaultDateTimeStyle) + Global.LineSeparator
                ...
                + StringPrefToString( "wordnetDictionaryFilename", com.conceptualgraph.charger.gloss.wn.WordnetManager.wordnetDictionaryFilename,
