...
public class FontPrefPanel extends javax.swing.JPanel {
    ...
    fontSample.setBackground(new java.awt.Color(255, 255, 255));
    fontSample.setText(com.conceptualgraph.chargerlib.FontChooser.getFontString( Global.defaultFont));
...
changeFont.addActionListener(new java.awt.event.ActionListener() {
    ...
    showAllFonts.setFont(new java.awt.Font("Lucida Grande", 0, 12)); // NOI18N
    ...
    private void showAllFontsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_showAllFontsItemStateChanged
