...
public class BasicTupleMatcher extends AbstractTupleMatcher
{
    ...
    {
       // com.conceptualgraph.charger.Global.info( "comparing \"" + masterTuple.relation_label + "\" and \"" + tupleToMatch.relation_label + "\"." );
     ...
     * @see #generousStringMatch(java.lang.String, java.lang.String) 
     */
    ...
    public boolean generousStringMatch( String ss1, String ss2 )
    {
        ...
        String s2 = ss2.replaceAll( nonAlphaNumericRegex, "" );
                ...
                //if ( ! s1.equals( ss1 ) ) com.conceptualgraph.charger.Global.info( "old string: \"" + ss1 + "\"; new string \"" + s1 + "\"" );
                //if ( ! s2.equals( ss2 ) ) com.conceptualgraph.charger.Global.info( "old string: \"" + ss2 + "\"; new string \"" + s2 + "\"" );
