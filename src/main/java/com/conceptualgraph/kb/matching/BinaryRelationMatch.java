...
public class BinaryRelationMatch
{
    ...
    */
    ...
    /**
        ...
        @see com.conceptualgraph.kb.ConceptManager#makeTableEntryArrayList(com.conceptualgraph.charger.obj.Concept, com.conceptualgraph.charger.obj.GNode, com.conceptualgraph.charger.obj.Concept, com.conceptualgraph.kb.ConceptManager.ConceptsToInclude)
    */
   ...
   public  String convertTuplesToHTMLtable( ArrayList tuples, String summary )
    ...
    /**
        ...
        @see com.conceptualgraph.kb.ConceptManager#getBinaryRelationTuples
     */
    public ArrayList<MatchedBinaryTuple> makeBinaryTuples( Graph masterG )
    {
        ArrayList<MatchedBinaryTuple> tupleList = new ArrayList<MatchedBinaryTuple>();
        ...
        while ( nodeiter.hasNext() )
        {
            ...
            {
                               // Craft.say( " found a relation/actor " + gn.getTextLabel() + " -- id " + gn.objectID );
                ...
                for ( int n1 = 0; n1 < edges.length; n1++ )
                    for ( int n2 = n1 + 1; n2 < edges.length; n2++ )
                    {
                        ...
                        tupleList.add( new MatchedBinaryTuple( c1, rel, c2 )  );
                    }
            }
        }
        java.util.Collections.sort( tupleList, new BinaryTuple.TupleComparator() );
        return tupleList;
    }
