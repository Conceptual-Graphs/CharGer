...
public class BinaryTuple
{
    ...
    */
    ...
    public String toHTML()
    {
        ...
        html += " <TD>" + 
            com.conceptualgraph.chargerlib.XMLGenerator.quoteForXML( concept1_label.toString().trim() ) + "\n";
        
        html += " <TD>" + 
        		com.conceptualgraph.chargerlib.XMLGenerator.quoteForXML( relation_label.toString().trim() ) + "\n";
        
        html += " <TD>" + 
        		com.conceptualgraph.chargerlib.XMLGenerator.quoteForXML( concept2_label.toString().trim() ) + "\n";
        return html;
    }
    ...
    public static class TupleComparator implements java.util.Comparator
    {
     /**
