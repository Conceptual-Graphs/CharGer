 ...
 */
public class SimpleActorPlugin implements com.conceptualgraph.charger.act.ActorPlugin
{
	...
	{
		return com.conceptualgraph.charger.act.GraphUpdater.createConceptList( 2, "T" );
	}
