...
public class RGTableModel extends AbstractTableModel  {
	...
	/*Returns the value for the cell at columnIndex and rowIndex. */
	{
		//try {
			RGAttribute a = (RGAttribute)rg.getAttributes().get( rowIndex );
					//Craft.say( "rg attribute is " + a );
			RGElement e = (RGElement)rg.getElements().get( columnIndex );
					//Craft.say( "rg element is " + e );
			RGCell c = rg.getCell( a, e );
					//Craft.say( "Cell at (" + rowIndex + "," + columnIndex + ") is " + c );
		...
		{
			Craft.say( "null pointer for RGTableModel: row = " + rowIndex + ", col = " + columnIndex );
			return null;
		}*/
	}  
	...
	public void	setValueAt( Object aValue, int rowIndex, int columnIndex ) 
	{
		...
		{
			com.conceptualgraph.charger.Global.error( "Exception in setValueAt: " + e.getMessage() );
