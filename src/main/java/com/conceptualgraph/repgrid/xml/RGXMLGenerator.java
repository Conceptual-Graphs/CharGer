 ...
 * <a href="http://www.saxproject.org/?selected=quickstart">SAX's web site</a>.
 *
 * @see com.conceptualgraph.repgrid.xml.RGXMLParser
 */
public class RGXMLGenerator extends com.conceptualgraph.chargerlib.XMLGenerator {
     ...
     * @return XML representation of the repertory grid, suitable for viewing or
     * saving.
     */
    ...
    private static String RGHeader( TrackedRepertoryGrid rg ) {
        ...
        if ( rg.valuetype != null ) {
            valuetypestring = rg.valuetype.getValueClass().getName();
        }
    ...
    private static String RGHeaderLabel( String indent, String labeltype, String text, ObjectLocator locator ) {
        ...
        if ( locator != null ) {
            ...
            Craft.say( "URI appended is " + locator.toURI() );
        }
        ...
        for ( int k = 0; k < rg.getAttributes().size(); k++ ) {
            {
                ...
                if ( rg.getAttributes().get( k ) instanceof com.conceptualgraph.repgrid.tracks.TrackedAttribute ) {
                	com.conceptualgraph.charger.gloss.AbstractTypeDescriptor[] descrs
                            = ( (com.conceptualgraph.repgrid.tracks.TrackedAttribute)rg.getAttributes().get( k ) ).getTypeDescriptors();
