...
//
package com.conceptualgraph.repgrid.tracks;
...
{	
	...
	public TrackedAttribute( RGAttribute attr )
	{
		...
		while ( cells.hasNext() )
		{
			...
			addCell( cellToCopy );
					//com.conceptualgraph.charger.Global.info( "replace attr for cell" );
		}
			//com.conceptualgraph.charger.Global.info( "constr for tracked attribute, old has " + attr.getCells().size() +
	...
	*/
	 ...
	 */
	public void setTypeDescriptor( String term, com.conceptualgraph.charger.gloss.AbstractTypeDescriptor descr )
	{
		if ( term != null && descr != null )
			//typeDescriptors.put( term, descr );
			typeDescriptors.add( descr );
				//Craft.say( "added descriptor for " + term + "; there are now " + typeDescriptors.size() +" descriptors." );
	}
	...
	*/
	public com.conceptualgraph.charger.gloss.AbstractTypeDescriptor getTypeDescriptor(String term )
	{
		//return (com.conceptualgraph.charger.obj.TypeDescriptor)typeDescriptors.get( term );
		for ( int k = 0; k < typeDescriptors.size(); k++ )
		{
			com.conceptualgraph.charger.gloss.AbstractTypeDescriptor d = (com.conceptualgraph.charger.gloss.AbstractTypeDescriptor)typeDescriptors.get( k );
	 ...
	 */
	public com.conceptualgraph.charger.gloss.AbstractTypeDescriptor[] getTypeDescriptors()
	{
		return (com.conceptualgraph.charger.gloss.AbstractTypeDescriptor[])(typeDescriptors.toArray( new com.conceptualgraph.charger.gloss.AbstractTypeDescriptor[0] ));
		//return (com.conceptualgraph.charger.obj.TypeDescriptor[])(typeDescriptors.values().toArray( new com.conceptualgraph.charger.obj.TypeDescriptor[0] ));
	}
