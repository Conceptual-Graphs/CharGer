...
//    String myLogicalFontName = null;
    ...
    public FontChooser( java.awt.Frame parent, boolean modal, Font font, String label, boolean showAllFonts ) {
        ...
        setTheFont( font );
        initComponents();
        initFontNameMenu( fontNameMenu, showAll );
...
//        }
    ...
    private void initComponents() {
        ...
        setFontButton.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        ...
        chooserLabel.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        chooserLabel.setForeground(new java.awt.Color(255, 255, 255));
        ...
        sampleText.setBorder(BorderFactory.createTitledBorder( General.BeveledBorder,
    ...
    fontStyleMenu.setBorder(BorderFactory.createTitledBorder( General.BeveledBorder,
...
fontStyleMenu.addItemListener(new java.awt.event.ItemListener() {
    ...
    fontSizeMenu.setBorder(BorderFactory.createTitledBorder( General.BeveledBorder,
...
fontSizeMenu.addActionListener(new java.awt.event.ActionListener() {
    ...
    fontNameMenu.setBorder(BorderFactory.createTitledBorder( General.BeveledBorder,
