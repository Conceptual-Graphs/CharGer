 ...
 * is actually scattered among all of the GUI options. Most of the dialog calls
 * are merely wrappers to JOptionPane methods.
 */
public class Transcript {
    ...
    public String showInputDialog( Component parentComponent, Object message, Object initialValue ) {
        ...
        if ( answer != null && answer.equals( initialValue ) ) {
            answer = "agrees with suggestion.";
        }
        log.append( user + answer + eol );
        return answer;
    }
