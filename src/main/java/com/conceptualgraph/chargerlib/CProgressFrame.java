...
public class CProgressFrame extends JFrame implements PropertyChangeListener {
    ...
    public CProgressFrame( JFrame p ) {
        initComponents();
        this.parent = p;
        this.getContentPane().setBackground( General.chargerBlueColor );
    }
    ...
    private void initComponents() {
        ...
        progressBar.setBackground(General.chargerBlueColor);
        progressBar.setOpaque(true);
        progressBar.setStringPainted(true);

        progressLabel.setBackground(General.chargerBlueColor);
