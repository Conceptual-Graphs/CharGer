...
public class QuantityBar extends JFrame implements ActionListener
{
	...
	//private Color paintColor = com.conceptualgraph.charger.Hub.chargerBlueColor;
...
//		public void paint( Graphics g )
		{
				...
				//	barwidth - 1, 2 );
			{
				...
				((Graphics2D)g).setStroke( General.defaultStroke );
...
//		public void paint( Graphics g )
	...
	private void setupMenus()
	{
		...
		closeItem.setAccelerator( KeyStroke.getKeyStroke( KeyEvent.VK_W, General.AcceleratorKey ) );
