 ...
 */
package com.conceptualgraph.chargerlib.undo;
...
public class UndoStateManager {
    ...
    /**
     * Supports the undo/redo operations. Should be protected, but we often need to display it for debugging.
     */
    protected UndoRedoList<UndoableState> urStack = null;
    /**
     ...
     * It is useful when maintaining multiple editing environments to forget all previous actions.
     */
    public void reset() {
        urStack.reset();
    }
