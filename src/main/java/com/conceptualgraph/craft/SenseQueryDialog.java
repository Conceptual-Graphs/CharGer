...
import com.conceptualgraph.charger.gloss.wn.WordnetManager;
...
public class SenseQueryDialog extends JDialog {
    ...
    private com.conceptualgraph.charger.gloss.wn.WordnetManager wnmgr = null;
     ...
     * wordnet query fails.
     *
     * @see com.conceptualgraph.charger.obj.TypeDescriptor#legalPartsOfSpeech
     */
    public SenseQueryDialog(
            Frame frame, String w, String p, AbstractTypeDescriptor defaultDescriptor, boolean tryGeneric ) {
...
//        transcript = trans;
        ...
        wnmgr = WordnetManager.getInstance(  );
        setup();
    }
    ...
    private void setup() {
        ...
        com.conceptualgraph.chargerlib.CGButton okButton = new com.conceptualgraph.chargerlib.CGButton();
        ...
        com.conceptualgraph.chargerlib.CGButton skipButton = new com.conceptualgraph.chargerlib.CGButton();
        skipButton.setText( com.conceptualgraph.charger.Global.strs( "SkipIgnoreLabel" ) );
        ...
        com.conceptualgraph.chargerlib.CGButton cancelButton = new com.conceptualgraph.chargerlib.CGButton();
        cancelButton.setText( com.conceptualgraph.charger.Global.strs( "CancelLabel" ) );
    ...
    private void setupWordnetChoices() {
        ...
        if ( synsetList.length != 0 ) {
            ...
            for ( int snum = 0; snum < synsetList.length; snum++ ) {
                ...
                //Craft.say( "gloss " + snum + " has length " + glossList[ snum ].length() );
        ...
        if ( def.getText().equals( "" ) ) {
            ...
            if ( wnmgr.wordExists( userword ) ) {
                SenseQueryDialog dialog = new SenseQueryDialog(
                        owner,  userword, word + "\" of \"" + phrase, null, false );
    ...
    class ComboBoxRenderer extends JPanel
       ...
       // setHorizontalAlignment( SwingConstants.LEFT );
        ...
        public Component getListCellRendererComponent(
            ...
            //Craft.say( "in get list cell renderer .. " );
