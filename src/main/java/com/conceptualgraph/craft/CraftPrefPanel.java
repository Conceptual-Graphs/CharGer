...
public class CraftPrefPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        gridFolderField.setText(Craft.GridFolder);
    ...
    tryGenericSenseInRepGrid.setBackground(new java.awt.Color(255, 255, 255));
    tryGenericSenseInRepGrid.setSelected(Craft.useOnlyBinaryRelationsinCraft);
    ...
    useOnlyBinaryRelationsinCraft.setBackground(new java.awt.Color(255, 255, 255));
    useOnlyBinaryRelationsinCraft.setSelected(Craft.useOnlyBinaryRelationsinCraft);
    ...
    useOnlyGenericConceptsinCraft.setBackground(new java.awt.Color(255, 255, 255));
    useOnlyGenericConceptsinCraft.setSelected(Craft.useOnlyGenericConceptsinCraft
    );
    ...
    private void setGridFolderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setGridFolderActionPerformed
        ...
        gridFolderField.setText( Craft.GridFolderFile.getAbsolutePath() );
    }//GEN-LAST:event_setGridFolderActionPerformed

    private void useOnlyBinaryRelationsinCraftItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_useOnlyBinaryRelationsinCraftItemStateChanged
    ...
    private void useOnlyGenericConceptsinCraftItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_useOnlyGenericConceptsinCraftItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
    ...
    private void tryGenericSenseInRepGridItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_tryGenericSenseInRepGridItemStateChanged
        if ( evt.getStateChange() == ItemEvent.SELECTED ) {
