...
public class Reporter {
    ...
    public static void displaySummary( JFrame owner ) {
        ...
        if ( summary == null ) {
            summary = new GenericTextFrame(
                    owner,
                    "Knowledge summary", "Knowledge summary for " + Craft.GridFolderFile.getAbsolutePath(),
                    getKnowledgeSummary(),
                    new java.io.File( Craft.GridFolderFile.getAbsolutePath(),
    ...
    public static String getKnowledgeSummary() {
        ...
        all = com.conceptualgraph.kb.ConceptManager.getAll( new com.conceptualgraph.charger.obj.Graph() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
        	com.conceptualgraph.charger.obj.Graph g = (com.conceptualgraph.charger.obj.Graph)iterall.next();
            s.append( natLang( g, true ) );
        }

        all = com.conceptualgraph.kb.ConceptManager.getAll( new com.conceptualgraph.charger.obj.Relation() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
        	com.conceptualgraph.charger.obj.Relation r = (com.conceptualgraph.charger.obj.Relation)iterall.next();
            s.append( natLang( r, true ) );
        }

        all = com.conceptualgraph.kb.ConceptManager.getAll( new com.conceptualgraph.charger.obj.Actor() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
        	com.conceptualgraph.charger.obj.Actor a = (com.conceptualgraph.charger.obj.Actor)iterall.next();
            s.append( natLang( a, true ) );
        }

        all = com.conceptualgraph.kb.ConceptManager.getAll( new com.conceptualgraph.charger.obj.Concept() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
        	com.conceptualgraph.charger.obj.Concept c = (com.conceptualgraph.charger.obj.Concept)iterall.next();
            if ( !visited.contains( c ) ) {
                s.insert( 0, natLang( c, true ) );
            }
        }

        all = com.conceptualgraph.kb.ConceptManager.getAll( new com.conceptualgraph.charger.obj.TypeLabel() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
        	com.conceptualgraph.charger.obj.TypeLabel t = (com.conceptualgraph.charger.obj.TypeLabel)iterall.next();
    ...
    public static String natLang(com.conceptualgraph.charger.obj.Graph g, boolean includeDefinitions ) {
        ...
        //if ( !  type.equalsIgnoreCase( "Proposition" ) || ! ref.equals( "" ) ) 
        {
            ...
            Iterator<GraphObject> concepts = new ShallowIterator( g, GraphObject.Kind.CONCEPT_OR_GRAPH );
            while ( concepts.hasNext() ) {
                if ( firstthrough ) {
                    s.append( eol + " consists of " );
                }
                com.conceptualgraph.charger.obj.Concept c = (com.conceptualgraph.charger.obj.Concept)concepts.next();
                if ( !concepts.hasNext() ) {
                    s.append( " and " );
	 ...
	 */
	public static String natLang(com.conceptualgraph.charger.obj.Concept c, boolean includeDefinitions ) {
     ...
     * they have one
     */
    public static String natLang(com.conceptualgraph.charger.obj.TypeLabel t, boolean includeDefinitions ) {
     ...
     * they have one
     */
    public static String natLang(com.conceptualgraph.charger.obj.GNode r, boolean includeDefinitions ) {
