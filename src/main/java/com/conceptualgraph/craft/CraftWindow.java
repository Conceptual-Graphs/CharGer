...
//
package com.conceptualgraph.craft;
...
import com.conceptualgraph.kb.ConceptManager;
import com.conceptualgraph.repgrid.*;
...
public class CraftWindow extends JFrame implements ManagedWindow {
    ...
    /**
     * Create the single com.conceptualgraph.craft window that controls elicitation.
     */
    public CraftWindow() {
    ...
    public void refresh() {
        ...
        //conceptTable = com.conceptualgraph.kb.ConceptManager.getConceptTable( CRConceptManager.GENERIC_ONLY );
        // gather only generic concepts
        //conceptTable = com.conceptualgraph.kb.ConceptManager.getBinaryTupleTable( com.conceptualgraph.kb.ConceptManager.GENERIC_ONLY );
        //conceptTable = com.conceptualgraph.kb.ConceptManager.getBinaryTupleTable( com.conceptualgraph.kb.ConceptManager.ConceptsToInclude.ALL );
//        if ( Craft.useOnlyGenericConceptsinCraft ) {
//            conceptTable = com.conceptualgraph.kb.ConceptManager.getBinaryTupleTable( com.conceptualgraph.kb.ConceptManager.ConceptsToInclude.GENERIC_ONLY );
//        } else {
//            conceptTable = com.conceptualgraph.kb.ConceptManager.getBinaryTupleTable( com.conceptualgraph.kb.ConceptManager.ConceptsToInclude.ALL );
//        }
...
//		TableSorter sorter = new TableSorter( conceptTable.getModel() );
        TableModel readonlymodel = new DefaultTableModel( new Object[1][], com.conceptualgraph.kb.BinaryTuple.getTupleColumnLabels().toArray() ) {
...
//        conceptTable.sortByColumn( 0 );
        ...
        if ( Craft.useOnlyGenericConceptsinCraft ) {
            conceptTable.setModel(ConceptManager.getBinaryTupleModel( ConceptManager.ConceptsToInclude.GENERIC_ONLY ));
        } else {
            conceptTable.setModel(ConceptManager.getBinaryTupleModel( ConceptManager.ConceptsToInclude.ALL ));
        }
        ...
        General.adjustTableColumnWidths( conceptTable );

        // these columns are used to hold the actual graph objects to be associated with the grid
        General.hideTableColumn(conceptTable.getColumnModel().getColumn(ConceptManager.COL_CONCEPT_1 ) );
        General.hideTableColumn(conceptTable.getColumnModel().getColumn(ConceptManager.COL_RELATION ) );
        General.hideTableColumn(conceptTable.getColumnModel().getColumn(ConceptManager.COL_CONCEPT_2 ) );
        //Util.hideTableColumn( conceptTable.getColumnModel().getColumn( com.conceptualgraph.kb.ConceptManager.COL_SUBGRAPH ) );
    ...
    private void setupMenuBar() {
        ...
        fileMenuPreferences.addActionListener( new java.awt.event.ActionListener() {
...
//        startGrid.setForeground( Color.white );
    ...
    private void refreshSouthPanel() {
        ...
        sentenceLabel.setText( ConceptManager.makeSentence( conceptOne, relation, conceptTwo ) );
...
//        WindowManager.refreshWindowMenuList( this );
     ...
     * @param e ignored
     */
    public void fileMenuPreferencesActionPerformed( java.awt.event.ActionEvent e ) {
        setCursor( new Cursor( Cursor.WAIT_CURSOR ) );
...
//        Global.pw.mainPane.setSelectedComponent( Global.pw.CraftPanel );
    ...
    public void performTupleSelection( ListSelectionEvent e ) {
        ...
        if ( lsm.isSelectionEmpty() ) {
            ...
            conceptOne = (Concept)conceptTable.getModel().getValueAt( selectedRow, com.conceptualgraph.kb.ConceptManager.COL_CONCEPT_1 );
            relation = (GNode)conceptTable.getModel().getValueAt( selectedRow, com.conceptualgraph.kb.ConceptManager.COL_RELATION );
            conceptTwo = (Concept)conceptTable.getModel().getValueAt( selectedRow, com.conceptualgraph.kb.ConceptManager.COL_CONCEPT_2 );
    ...
    public void performStartGrid() {
        ...
        if ( conceptOne.getOwnerFrame() != null ) {
            newname.append(General.stripFileExtension(
                    conceptOne.getOwnerFrame().graphAbsoluteFile.getAbsolutePath() ) );
        } else {
            newname.append(General.stripFileExtension( g.name ) );
        }
    ...
    /*
     ...
     {
     String XMLSummary = com.conceptualgraph.charger.xml.XMLGenerator.quoteForXML( summary.trim() );
     ...
     html += " <TD>" + 
     com.conceptualgraph.charger.xml.XMLGenerator.quoteForXML( jt.getValueAt( row, col).toString().trim() ) + "\n";
     }
     // html += "</row>\n";
     }
     html += "</TABLE>";
    ...
    /*
     ...
     if ( jt.getCellRect( row, col, false ).getWidth() > 0 )
     html += "  <col number = '" + col + "'>" + 
     com.conceptualgraph.charger.xml.XMLGenerator.quoteForXML( jt.getValueAt( row, col).toString() ) + "</col>\n";
     }
     html += "</row>\n";
     }
     html += "</TABLE>";
