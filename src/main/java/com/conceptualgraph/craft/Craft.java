...
//    private static Craft instance = null;
    ...
    public  static JMenuItem backToCraftCmdItem = new JMenuItem( com.conceptualgraph.charger.Global.strs( "BackToCraftCmdLabel" ) );
    ...
    public Craft() {
        ...
        //backToCraftCmdItem.addActionListener( com.conceptualgraph.charger.Hub.CharGerMasterFrame );
        craftWindow.toFront();
...
//    }
    ...
    public static  void queryForGridFolder( JFrame f ) {
        File newF = com.conceptualgraph.charger.Global.queryForFolder(f, GridFolderFile,
    ...
    public static  void say( String s ) {
        if ( com.conceptualgraph.charger.Global.infoOn ) {
